...
numérico da glicose em um banco de dados e gostaria de rotular
...
glicemia = [('Hipoglicemia', item) if item <= 70 else 
            ('Normal', item) if item > 70 and item <= 99 else
            ('Alterada', item) if item > 100 and item <= 125 else
            ('Diabetes', item)
